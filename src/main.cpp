...
int64_t GetBlockValue(int nHeight)
{
    if (nHeight == 0) {
        return 1000 * COIN;
    } else if (nHeight > 0 && nHeight <= 3) {
        return 10000 * COIN;
    } else if (nHeight > 3 && nHeight <= 10) {
        return 5000000 * COIN;
    } else if (nHeight > 10 && nHeight <= 100010) {
        return 250 * COIN;
    } else if (nHeight > 100010 && nHeight <= 300010) {
        return 200 * COIN;
    } else if (nHeight > 300010 && nHeight <= 600010) {
        return 150 * COIN;
    } else if (nHeight > 600010 && nHeight <= 1200010) {
        return 100 * COIN;
    } else if (nHeight > 1200010 && nHeight <= 2200010) {
        return 75 * COIN;
    } else if (nHeight > 2200010 && nHeight <= 3200010) {
        return 50 * COIN;
    } else {
        return 10 * COIN;
    }
